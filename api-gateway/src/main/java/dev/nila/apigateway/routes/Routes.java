...
public class Routes {
    ...
    //we are using spring webmvc functional
    //if fail this route will call and send the custom msg
    //whenever we received the request we will reply back this status and body
    @Bean
